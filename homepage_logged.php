...
<html>
  <head>
    ...
    <link rel="stylesheet" href="style_homepage_logged.css" />
  </head> 
  <body>
            ...
            <div class="primary-button-l">
              <div class="primary-button-l-wrapper">
                <div class="primary-button-l-2">
                    <a href="topik_logged.php" class="primary-button-l-3">Telusuri Temanmu</a>
                </div>
            </div>
            </div>
          </div>
        ...
        <div class="desktop-2">
          <div class="overlap-2">
            ...
            <div class="primary-button-l-5">
              <div class="primary-button-l-wrapper">
                <div class="primary-button-l-2">
                    <a href="curhatanmu.php" class="primary-button-l-3">Mulai Curhat</a>
                </div>
              </div>
            </div>
          </div>
