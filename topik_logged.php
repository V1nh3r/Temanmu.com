...
<html>
  <head>
    ...
    <link rel="stylesheet" href="style_topik_logged.css" />
  </head>
  <body>
      ...
      <div class="div">
        <div class="overlap-group">
          ...
          <div class="header-baru-banget">
            ...
            <div class="frame">
              <div class="element">
                <a href="homepage_logged.php" class="text-wrapper-2">Beranda</a>
              </div>
              ...
              <div class="button-text-wrapper">
                <a href="tentang-kami_logged.php" class="text-wrapper-4">Tentang kami</a>
              </div>
          ...
          <div class="frame-2">
            <div class="frame-3">
              <div class="button-with-icon">
                ...
                <a href="curhatanmu.php" class="button-icon">Percintaan</a>
              </div>
              <div class="button-with-icon">
                <div class="bff"></div>
                <a href="curhatanmu.php" class="button-icon">Persahabatan</a>
              </div>
              <div class="button-with-icon">
                <div class="stress"></div>
                <a href="curhatanmu.php" class="button-icon">Depresi</a>
              </div>
            </div>
            <div class="frame-3">
              <div class="button-with-icon">
                <div class="family"></div>
                <a href="curhatanmu.php" class="button-icon">Keluarga</a>
              </div>
              <div class="button-with-icon">
                <div class="appearance"></div>
                <a href="curhatanmu.php" class="button-icon">Penampilan</a>
              </div>
              <div class="button-with-icon">
                <div class="doctor"></div>
                <a href="curhatanmu.php" class="button-icon">Kesehatan</a>
              </div>
            </div>
            <div class="frame-3">
              <div class="button-with-icon">
                <div class="briefcase"></div>
                <a href="curhatanmu.php" class="button-icon">Pekerjaan</a>
              </div>
              <div class="button-with-icon">
                <div class="trauma"></div>
                <a href="curhatanmu.php" class="button-icon">Trauma</a>
              </div>
              <div class="button-with-icon">
                <div class="coins"></div>
                <a href="curhatanmu.php" class="button-icon">Keuangan</a>
              </div>
            </div>
            <div class="frame-3">
              <div class="button-with-icon">
                <div class="graduation-cap"></div>
                <a href="curhatanmu.php" class="button-icon">Pendidikan</a>
              </div>
              <div class="button-with-icon">
                <div class="routine"></div>
                <a href="curhatanmu.php" class="button-icon">Keseharian</a>
              </div>
              <div class="button-with-icon">
                <div class="luggage"></div>
                <a href="curhatanmu.php" class="button-icon">Liburan</a>
              </div>
            </div>
          </div>
        </div>
        <footer class="footer">
          ...
          <div class="frame-5">
            <div class="button-text">
              <a href="homepage_logged.php" class="button-text-2">Beranda</a>
             </div>
